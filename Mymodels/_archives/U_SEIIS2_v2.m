function [U,dU] = U_SEIIS2_v2(beta1,gamma1,nu1,sigma1,eps1,beta2,gamma2,nu2,sigma2,eps2,b,mu,vecRho,c,alpha1,alpha2,f)
    ...
    %pb of precision with R1 and R2
    i=1;
    for rho=vecRho
        ...
        elseif rho>=alpha1 && rho<alpha2
            U(i) = U_SEIISv2(eps2, beta2, sigma2, gamma2, mu, nu2, rho, c, alpha2,f);
