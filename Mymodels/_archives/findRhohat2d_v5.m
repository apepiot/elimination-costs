function [rhohat, rhohat2d] = findRhohat2d_v5(c,type1,type2,rhohat1,rhohat2,param1,param2,mu,b,f)
...
%SEIISxSICTP model   
elseif strcmp(type1,"SEIIS") && strcmp(type2,"SICTP")     
    fun21 = @(rho) -U12_SICTPSEIIS_v1(param2,param1,mu,b,rho,c,f,'fsolve',opt);
