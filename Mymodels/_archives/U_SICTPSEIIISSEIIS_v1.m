function [U] = U_SICTPSEIIISSEIIS_v1(param1,param2,param3,mu,b,vecRho,c,f)                                 
    ...
    for rho=vecRho
        if rho<alpha1 && rho<alpha2 && rho<alpha3 %R1(i)>1 && R2(i)>1 && R3(i)>1
            U(i) = U123_SICTPSEIIISSEIIS_v1(param1,param2,param3,mu,b,rho,c,f,'fsolve',opt);
        elseif rho>=alpha1 %R1(i)<=1 && R2(i)>1 && R3(i)>1
            U(i) = U_SEIISSEIIIS_v4(param3,param2,mu,b,rho,c,f);
        ...
        elseif rho>=alpha3 %R1(i)>1 && R2(i)>1 && R3(i)<=1
            U(i) = U_SICTPSEIIIS_v1(param1,param2,mu,b,rho,c,f); 
        end
        i=i+1;
    end
end