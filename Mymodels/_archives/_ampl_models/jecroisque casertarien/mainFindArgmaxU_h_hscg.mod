...
#Prevalence of asymptomatic HIV in the kit
set asympt_h := (H_infectious diff C_IS) diff G_IS;
var Prevalence_H_HSCG = sum{k in asympt_h} (Y[k])/N_equ;

# Objective function to be minimized.
minimize Cost: rho_hscg*(c - Prevalence_H_HSCG);
