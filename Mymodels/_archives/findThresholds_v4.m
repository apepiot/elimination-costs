function [tabcs] = findThresholds_v4(nSEIIS,nSICR,nSEIIIS,tab,vecAlpha,vecC)
    ...
    if N==1
        ...
        elseif nSICR==1
            [~,tabcs.c0] = U1_SICR_v4(param,param.mu,param.b,0,0,1);
            [~,tabcs.cs1dis] = U1_SICR_v4(param,param.mu,param.b,param.alpha,0,1); 
        end
