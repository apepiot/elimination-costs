...
N=b/mu;
% if rho_h~=0
%     warning('attention car ici rho_h different de 0, donc ce n est pas coherent si le kit testé est hc ou hg')
% end
...
dY(23) = Lambdah*Y(22) - Y(23)*(gammaCt + mu + nuCt + rho_h + sigmah) + Y(9)*epsCt*sigmaCt;
dY(24) = Y(23)*sigmah - Y(24)*(gammaCt + mu + nuCt + rho_h + thetah) + Y(10)*epsCt*sigmaCt;
...
dY(28) = Y(26)*eta_h_prep + Y(23)*rho_h - Y(28)*(eta_c_art + gammaCt + mu + nuCt) + Y(27)*(eta_h_prep + thetah) + Y(24)*(rho_h + thetah) + Y(14)*epsCt*sigmaCt;
