function [ES,P,P_inf,iterNo,restart,changeSolver,msg_err,status] = P1234_SICTPSEIIISSEIIS2_v5(param1,param2,param3,param4,mu,b,paramRho,f,solvingMethod,maxIter,verbose)
...
while restart && iterNo<maxIter
    ...
    elseif isequal(solvingMethod,'ode45')
        ...
        [res] = ode45(@(t,Y) ODE_SICTPSEIIISSEIIS2_v6(t,Y,allParams{:}),tspan, Y0, options);
        ES = res.y(:,end);
