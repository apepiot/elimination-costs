function [dY] = ODE_V5(t,Y,b,beta1,beta2,e1,e2,s1,s2,rho,gamma1,gamma2,mu,type)
%strategy 2 february 2021
    ...
    lambda2 = beta2*(IR2 + I2)/N + e2*I12/N;
    ...
    dI12    = lambda2*I1 + lambda1*I2 - (gamma2p+gamma1p + mu)*I12;%I12
    dIR2    = gamma1p*I12 + lambda2*R1  - (gamma2p + mu)*IR2; %IR2
