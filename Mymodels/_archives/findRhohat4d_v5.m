function [rhohat,rhohat4d] = findRhohat4d_v5(c,type1,type2,type3,type4,...
    ...
    if strcmp(type1,"SEIIS") && strcmp(type2,"SEIIS") && strcmp(type3,"SICTP") && strcmp(type4,"SEIIIS")
        ...
        opt.TolFun=1e-5;
        fun1234 = @(rho) -U1234_SICTPSEIIISSEIIS2_v1(param3,param4,param1,param2,mu,b,rho,c,f,'fsolve',opt);
        ...
        U_list = U_SICTPSEIIISSEIIS2_v1(param3,param4,param1,param2,...
