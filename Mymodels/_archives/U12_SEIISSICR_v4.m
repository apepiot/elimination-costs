function [U12,dU,P] = U12_SEIISSICR_v4(param1,param2,mu,b,vecRho,c,f,solveMethod,optSolver)
    %     HIV,STI
    % [ X1, 1, 1]
    % [ X2, 2, 1]
    % [ X3, 3, 1]
    ...
    for RHO=vecRho
        ...
        if(isequal(solveMethod,'ode45'))
            ...
            [~,Ys] = ode45(@(t,Y) ODE_SEIISSICR_v4(t,Y,beta1,nu1,eps1,sigma1,gamma1,...
        ...
        if(isequal(solveMethod,'fsolve'))
            ...
            [ES] = fsolve(@(Y)  ODE_SEIISSICR_v4(1,Y,beta1,nu1,eps1,sigma1,gamma1,...
