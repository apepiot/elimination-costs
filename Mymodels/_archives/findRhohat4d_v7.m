function [rhohat,rhohat4d] = findRhohat4d_v7(c,type1,type2,type3,type4,...
                                                rhohat1d,rhohat2d,rhohat3d,...
                                                param1,param2,param3,param4,mu,b,f)

    %This function finds the argmax of U in a 4-diseases model. 
    ...
    if strcmp(type1,"SEIIS") && strcmp(type2,"SEIIS") && strcmp(type3,"SICTP") && strcmp(type4,"SEIIIS")
        %disp(['avant ode system']); toc
        opt.TolFun=1e-5;
        fun1234 = @(rho) -U1234_SICTPSEIIISSEIIS2_v2(param3,param4,param1,param2,mu,b,paramRho,c,f,'knitro-ampl',opt);
        ...
        U_list = U_SICTPSEIIISSEIIS2_v2(param3,param4,param1,param2,...
